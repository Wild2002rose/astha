                        ...
                        {branches.length > 0 ? (
                            branches.map((branch) => (
                                <div key={branch.branchId} className="branch rounded-lg shadow-lg ">
                                    ...
                                    <p className="text-lg bg-transparent mt-2 ml-4 font-semibold text-white"><strong className="font-semibold">Contact Number:</strong> {branch.branchContactNumber}</p>
                                    <p className="text-lg bg-transparent mt-2 ml-4 font-semibold text-white"><strong className="font-semibold">Email:</strong> {branch.branchContactEmail}</p>
