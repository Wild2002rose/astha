        ...
        <div className="min-h-screen">
            ...
            {error ? (
                    ...
                    <div className="bg-transparent singlebranch ml-1 mt-4">
                        ...
                        <p className=" bg-transparent mb-4"><strong className="font-semibold bg-transparent text-2xl ">Contact:</strong> {branch.branchContactNumber}</p>
                        <p className=" bg-transparent mb-4"><strong className="font-semibold bg-transparent text-2xl">Email:</strong> {branch.branchContactEmail}</p>
